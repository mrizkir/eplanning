...
class Plafon7Controller extends Controller {
     /**
    ...
    {               
        ...
        $data='salah format. yang benar https://e-gemilang.bintankab.go.id/api/v0/rkpd/plafon7/OrgID';
