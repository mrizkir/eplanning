...
class UsulanController extends Controller 
{
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.rkpd.usulan.create")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>$this->getPageTitle(),
        ...
        {
            return view("pages.$theme.rkpd.usulan.error")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>$this->getPageTitle(),
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.rkpd.usulan.create1")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>$this->getPageTitle(),
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.rkpd.usulan.create2")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>$this->getPageTitle(),
                                                                    'renja'=>$renja,
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.rkpd.usulan.create3")->with(['page_active'=>$this->NameOfPage,
                                                                            'page_title'=>$this->getPageTitle(),
                                                                            'renja'=>$renja,
                                                                            'datarinciankegiatan'=>$datarinciankegiatan,
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            $daftar_kecamatan=\App\Models\DMaster\KecamatanModel::getDaftarKecamatan(config('globalsettings.tahun_perencanaan'),config('globalsettings.defaul_kota_atau_kab'),false);
            $nomor_rincian = RenjaRincianModel::where('RenjaID',$renjaid)->max('No')+1;
            return view("pages.$theme.rkpd.usulan.create4")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>$this->getPageTitle(),
                                                                    'renja'=>$renja,
                                                                    'nomor_rincian'=>$nomor_rincian,
                                                                    'datarinciankegiatan'=>$datarinciankegiatan,
    ...
    public function show($id)
    {
        ...
        if (!is_null($renja) )  
        {
            ...
            return view("pages.$theme.rkpd.usulan.show")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
                                                                'dataindikatorkinerja'=>$dataindikatorkinerja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
    ...
    public function showrincian($id)
    {
        ...
        if (!is_null($data) )  
        {            
            return view("pages.$theme.rkpd.usulan.showrincian")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$data,
                                                                'item'=>$data
                                                            ]);
    ...
    public function edit($id)
    {
        ...
        {
            $sumber_dana = \App\Models\DMaster\SumberDanaModel::getDaftarSumberDana(config('globalsettings.tahun_perencanaan'),false);     
            return view("pages.$theme.rkpd.usulan.edit")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
                                                                'sumber_dana'=>$sumber_dana
                                                                ]);
    ...
    public function edit1($id)
    {
        ...
        {    
            ...
            return view("pages.$theme.rkpd.usulan.edit1")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
    ...
    public function edit2($id)
    {
        ...
        {               
            ...
            return view("pages.$theme.rkpd.usulan.edit2")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
                                                                ]);
    ...
    {   
        ...
        {               
            ...
            return view("pages.$theme.rkpd.usulan.edit3")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
                                                                ]);
    ...
    {   
        ...
        {               
            ...
            return view("pages.$theme.rkpd.usulan.edit4")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>$this->getPageTitle(),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan,
                                                                'daftar_provinsi'=> $daftar_provinsi,
    ...
    public function destroy(Request $request,$id)
    {
        ...
        if ($request->exists('indikatorkinerja'))
        {
            ...
            if ($request->ajax()) 
            {
                ...
                $datatable = view("pages.$theme.rkpd.usulan.datatableindikatorkinerja")->with(['dataindikatorkinerja'=>$data])->render();     
        ...
        else  if ($request->exists('rinciankegiatan'))
        {
            ...
            if ($request->ajax()) 
            {
                ...
                $datatable = view("pages.$theme.rkpd.usulan.datatablerinciankegiatan")
                                ->with([
