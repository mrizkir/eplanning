...
class UsulanForumOPDController extends Controller {
    ...
    public function update1(Request $request, $id)
    {
        ...
        {
            return redirect(route('usulanforumopd.show',['id'=>$indikatorkinerja->RenjaID]))->with('success','Data Indikator kegiatan telah berhasil disimpan. Selanjutnya isi Rincian Kegiatan');
        }
    }
    /**
     * Store a newly created resource in storage.
