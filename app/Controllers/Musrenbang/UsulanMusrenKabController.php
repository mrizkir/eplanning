...
class UsulanMusrenKabController extends Controller {
    ...
    public function update1(Request $request, $id)
    {
        ...
        {
            return redirect(route('usulanmusrenkab.show',['id'=>$indikatorkinjera->RenjaID]))->with('success','Data Indikator kegiatan telah berhasil disimpan. Selanjutnya isi Rincian Kegiatan');
        }
    }
    /**
     * Store a newly created resource in storage.
