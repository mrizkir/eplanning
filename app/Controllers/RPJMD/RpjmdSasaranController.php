...
class RpjmdSasaranController extends Controller {
    ...
    {        
        ...
        //{            
        //    $this->putControllerStateSession('rpjmdsasaran','orderby',['column_name'=>'replace_it','order'=>'asc']);
        //}
        ...
        if ($this->checkStateIsExistSession('rpjmdsasaran','search')) 
        {
            ...
            {
                case 'replaceit' :
                    $data = RpjmdSasaranModel::where(['replaceit'=>$search['isikriteria']])->orderBy($column_order,$direction); 
                break;
                case 'replaceit' :
                    $data = RpjmdSasaranModel::where('replaceit', 'like', '%' . $search['isikriteria'] . '%')->orderBy($column_order,$direction);                                        
                break;
            }           
