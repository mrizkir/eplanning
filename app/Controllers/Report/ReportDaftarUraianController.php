...
{    
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null && $locked==false)
        {
            ...
            return view("pages.$theme.report.reportdaftaruraian.create")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.report.reportdaftaruraian.create1")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.report.reportdaftaruraian.create2")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                    'renja'=>$renja,
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            return view("pages.$theme.report.reportdaftaruraian.create3")->with(['page_active'=>$this->NameOfPage,
                                                                            'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                            'renja'=>$renja,
                                                                            'datarinciankegiatan'=>$datarinciankegiatan,
    ...
    {        
        ...
        if ($filters['SOrgID'] != 'none'&&$filters['SOrgID'] != ''&&$filters['SOrgID'] != null)
        {
            ...
            $daftar_kecamatan=\App\Models\DMaster\KecamatanModel::getDaftarKecamatan(\HelperKegiatan::getTahunPerencanaan(),config('eplanning.default_kota_atau_kab'),false);
            $nomor_rincian = RenjaRincianModel::where('RenjaID',$renjaid)->count('No')+1;
            return view("pages.$theme.report.reportdaftaruraian.create4")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                    'renja'=>$renja,
                                                                    'nomor_rincian'=>$nomor_rincian,
                                                                    'datarinciankegiatan'=>$datarinciankegiatan,
    ...
    public function show($id)
    {
        ...
        if (!is_null($renja) )  
        {
            ...
            return view("pages.$theme.report.reportdaftaruraian.show")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
                                                                'dataindikatorkinerja'=>$dataindikatorkinerja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
    ...
    public function showrincian($id)
    {
        ...
        {            
            ...
            return view("pages.$theme.report.reportdaftaruraian.showrincian")->with(['page_active'=>$this->NameOfPage,
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                                'renja'=>$data,
                                                                                'filters'=>$filters,
                                                                                'daftar_opd'=>$daftar_opd,
    ...
    public function edit($id)
    {
        ...
        if (!is_null($renja) ) 
        {
            ...
            $sumber_dana = \App\Models\DMaster\SumberDanaModel::getDaftarSumberDana(\HelperKegiatan::getTahunPerencanaan(),false);     
            return view("pages.$theme.report.reportdaftaruraian.edit")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
                                                                'organisasi'=>$organisasi,
                                                                'daftar_program'=>$daftar_program,
    ...
    public function edit1($id)
    {
        ...
        {    
            ...
            return view("pages.$theme.report.reportdaftaruraian.edit1")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
    ...
    public function edit2($id)
    {
        ...
        {               
            ...
            return view("pages.$theme.report.reportdaftaruraian.edit2")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
                                                                ]);
    ...
    {   
        ...
        {               
            ...
            return view("pages.$theme.report.reportdaftaruraian.edit3")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan
                                                                ]);
    ...
    {   
        ...
        {               
            ...
            return view("pages.$theme.report.reportdaftaruraian.edit4")->with(['page_active'=>$this->NameOfPage,
                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                                                'renja'=>$renja,
                                                                'datarinciankegiatan'=>$datarinciankegiatan,
                                                                'daftar_provinsi'=> $daftar_provinsi,
    ...
    public function destroy(Request $request,$id)
    {
        ...
        if ($request->exists('indikatorkinerja'))
        {
            ...
            if ($request->ajax()) 
            {
                ...
                $datatable = view("pages.$theme.report.reportdaftaruraian.datatableindikatorkinerja")
                                ->with([
        ...
        elseif ($request->exists('rinciankegiatan'))
        {
            ...
            if ($request->ajax()) 
            {
                ...
                $datatable = view("pages.$theme.report.reportdaftaruraian.datatablerinciankegiatan")
                                ->with([
                                    'page_active'=>$this->NameOfPage,
                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
                                    'renja'=>$renja,
