...
class ReportRKPDMurniOPDController extends Controller 
{    
    /**
    ...
    public function filter(Request $request) 
    {
        ...
        if ($request->exists('OrgID'))
        {
            ...
            $datatable = view("pages.$theme.report.reportrkpdmurniopd.datatable")->with(['page_active'=>$this->NameOfPage,   
    ...
    {  
        ...
        return view("pages.$theme.report.reportrkpdmurniopd.index")->with(['page_active'=>$this->NameOfPage, 
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
    ...
    {       
        ...
        {
            return view("pages.$theme.report.reportrkpdmurniopd.error")->with(['page_active'=>$this->NameOfPage,
                                                                    'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
