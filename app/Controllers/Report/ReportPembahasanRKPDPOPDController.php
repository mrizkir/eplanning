...
class ReportPembahasanRKPDPOPDController extends Controller 
{    
    /**
    ...
    public function filter(Request $request) 
    {
        ...
        if ($request->exists('OrgID'))
        {
            ...
            $datatable = view("pages.$theme.report.reportpembahasanrkpdpopd.datatable")->with(['page_active'=>$this->NameOfPage,   
    ...
    {  
        ...
        return view("pages.$theme.report.reportpembahasanrkpdpopd.index")->with(['page_active'=>$this->NameOfPage, 
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
    ...
    {       
        ...
        {            
            return view("pages.$theme.report.reportpembahasanrkpdpopd.error")->with(['page_active'=>$this->NameOfPage,
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
