...
class ReportPembahasanRKPDMurniOPDController extends Controller 
{    
    /**
    ...
    public function filter(Request $request) 
    {
        ...
        if ($request->exists('OrgID'))
        {
            ...
            $datatable = view("pages.$theme.report.reportpembahasanrkpdmurniopd.datatable")->with(['page_active'=>$this->NameOfPage,   
    ...
    {  
        ...
        return view("pages.$theme.report.reportpembahasanrkpdmurniopd.index")->with(['page_active'=>$this->NameOfPage, 
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
