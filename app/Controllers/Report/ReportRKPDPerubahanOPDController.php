...
class ReportRKPDPerubahanOPDController extends Controller 
{    
    /**
    ...
    public function filter(Request $request) 
    {
        ...
        if ($request->exists('OrgID'))
        {
            ...
            $datatable = view("pages.$theme.report.reportrkpdperubahanopd.datatable")->with(['page_active'=>$this->NameOfPage,   
    ...
    {  
        ...
        return view("pages.$theme.report.reportrkpdperubahanopd.index")->with(['page_active'=>$this->NameOfPage, 
                                                                                'page_title'=>\HelperKegiatan::getPageTitle($this->NameOfPage),
