...
{   
    ...
    {
        $writer=$this->writer;
        $this->customTempFolderPath.DIRECTORY_SEPARATOR.$filename;
        ...
        foreach ($daftar_program as $v)
        {
            ...
            $cells = [
                ...
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell(''),
                WriterEntityFactory::createCell($totalpagueachprogram),
            ];
            ...
            foreach ($daftar_kegiatan as $n) 
            {
                $cells=[
                    ...
                    WriterEntityFactory::createCell(\Helper::formatUang($n['NilaiUsulan1']))
                ];
                $multipleRows = [
                    WriterEntityFactory::createRow($cells)
                ];
