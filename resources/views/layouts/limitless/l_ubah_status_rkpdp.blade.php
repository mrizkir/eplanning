<li class="dropdown text-teal-600">
    ...
    <ul class="dropdown-menu dropdown-menu-right" style="font-size:8px">
        ...
        <li class="text-primary-600">        
            <a class="btnEdit" href="{{route($page_active.'.edit',['id'=>$item->RKPDRincID])}}" title="Ubah Data Usulan">
        ...
        @endif
         <li class="text-primary-600">        
            <a href="{{route($page_active.'.show',['id'=>$item->RKPDID])}}" title="Detail Data Usulan">
                <i class='icon-eye'></i> DETAIL KEGIATAN
            </a>             
        </li> 
        <li class="text-primary-600">        
            <a href="{{route($page_active.'.showrincian',['id'=>$item->RKPDRincID])}}" title="Detail Data Rincian Usulan">
