...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>'Aspirasi\PemilikBansosHibahController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                <div class="form-group">
                    {{Form::label('Kd_PK','KODE',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Kd_PK','',['class'=>'form-control','placeholder'=>'Kode Pemilik Bantuan Sosial dan Hibah'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('NmPk','NAMA',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('NmPk','',['class'=>'form-control','placeholder'=>'Nama Pemilik Bantuan Sosial dan Hibah'])}}
                    </div>
                </div>
                <div class="form-group">
