    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            {!! Form::open(['url'=>'#','method'=>'post','class'=>'heading-form','id'=>'frmheading','name'=>'frmheading'])!!} 
                ...
                <div class="form-group">
                    <a href="{!!route('pemilikbansoshibah.create')!!}" class="btn btn-info btn-xs" title="Tambah Pemilik POKIR">
                    ...
                    <td>
                        <ul class="icons-list">
                            ...
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data Pemilik Bantuan Sosial dan Hibah" data-id="{{$item->PemilikBansosHibahID}}" data-url="{{route('pemilikbansoshibah.index')}}">
