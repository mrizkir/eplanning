...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>'Aspirasi\BansosHibahController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
        <div class="panel-body">            
            <div class="form-group">
                {{Form::label('PemilikBansosHibahID','NAMA PEMILIK',['class'=>'control-label col-md-2'])}}
                <div class="col-md-10">
                    {{Form::select('PemilikBansosHibahID', $daftar_pemilik,$filters['PemilikBansosHibahID'],['class'=>'form-control','id'=>'PemilikBansosHibahID'])}}
                </div>
            </div>                               
        </div>        
        <div class="panel-body">                                
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::textarea('Output','',['class'=>'form-control','placeholder'=>'OUTPUT / HASIL','rows'=>2])}}
                </div>
            </div>             
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::select('Jeniskeg', [1=>'BANTUAN SOSIAL',2=>'HIBAH'],1,['class'=>'form-control','id'=>'Jeniskeg'])}}
                </div>
            </div>
        </div>         
        <div class="panel-body">
