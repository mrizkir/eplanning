    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            {!! Form::open(['url'=>'#','method'=>'post','class'=>'heading-form','id'=>'frmheading','name'=>'frmheading'])!!} 
                ...
                <div class="form-group">
                    <a href="{!!route('bansoshibah.create')!!}" class="btn btn-info btn-xs" title="Tambah Bantuan Sosial dan Hibah">
                ...
                <ul class="icons-list">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a href="{!!route('bansoshibah.printtoexcel')!!}" title="Print to Excel" id="btnprintexcel">
                    ...
                    <td>
                        <ul class="icons-list">
                            ...
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data Bantuan Sosial dan Hibah" data-id="{{$item->BansosHibahID}}" data-url="{{route('bansoshibah.index')}}">
