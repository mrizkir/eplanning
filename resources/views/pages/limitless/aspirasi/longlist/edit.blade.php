...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>['Aspirasi\LongListController@update',$data->LongListID],'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                      
        <div class="panel-body">                      
            <div class="form-group">
                {{Form::label('KgtNm','NAMA KEGIATAN',['class'=>'control-label col-md-2'])}}
                <div class="col-md-10">
                    {{Form::textarea('KgtNm',$data['KgtNm'],['class'=>'form-control','placeholder'=>'NAMA KEGIATAN','rows'=>2])}}
                </div>
            </div>            
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-6">
                            {{Form::text('Sasaran_Angka',$data['Sasaran_Angka'],['class'=>'form-control','placeholder'=>'ANGKA SASARAN'])}}
                        </div>
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian',$data['Sasaran_Uraian'],['class'=>'form-control','placeholder'=>'URAIAN SASARAN','rows'=>3,'id'=>'Sasaran_Uraian'])}}
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function () {
    AutoNumeric.multiple(['#Sasaran_Angka'], {
                                        ...
                                        numericPos:true,
                                        decimalPlaces : 0,
                                        digitGroupSeparator : $data['replace'],
                                        showWarnings:false,
