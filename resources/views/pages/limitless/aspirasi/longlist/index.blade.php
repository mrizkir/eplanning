...
<div class="row">    
    ...
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'Aspirasi\LongListController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        <label class="col-md-2 control-label">Kriteria :</label> 
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['KgtNm'=>'NAMA KEGIATAN'], isset($search['kriteria'])?$search['kriteria']:'KgtNm',['class'=>'form-control'])}}
                        </div>
                    </div>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.aspirasi.longlist.datatable')
    </div>   
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Long List dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
