            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'RENSTRA\RENSTRAVisiController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['Kd_RenstraVisi'=>'KODE VISI','Nm_RenstraVisi'=>'NAMA VISI'], isset($search['kriteria'])?$search['kriteria']:'Kd_RenstraVisi',['class'=>'form-control'])}}
                        </div>
                    </div>
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RENSTRA Visi dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
