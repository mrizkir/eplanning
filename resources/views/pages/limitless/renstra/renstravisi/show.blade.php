        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">   
                    <a href="{{route('renstravisi.edit',['id'=>$data->renstravisi_id])}}" class="btn btn-primary btn-icon heading-btn btnEdit" title="Ubah Data RenstraVisi">
                        <i class="icon-pencil7"></i>
                    </a>
                    <a href="javascript:;" title="Hapus Data RenstraVisi" data-id="{{$data->renstravisi_id}}" data-url="{{route('renstravisi.index')}}" class="btn btn-danger btn-icon heading-btn btnDelete">
...
$(document).ready(function () {
    $(".btnDelete").click(function(ev) {
        if (confirm('Apakah Anda ingin menghapus Data RenstraVisi ini ?')) {
