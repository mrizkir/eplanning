...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>['RENSTRA\RENSTRAMisiController@update',$data->RenstraMisiID],'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                <div class="form-group">
                    {{Form::label('RenstraVisiID','VISI',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::select('RenstraVisiID', $daftar_visi,$data->RenstraVisiID,['class'=>'select','id'=>'RenstraVisiID'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Kd_RenstraMisi','KODE',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Kd_RenstraMisi',$data->Kd_RenstraMisi,['class'=>'form-control','placeholder'=>'Kode Misi','maxlength'=>'4'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Nm_RenstraMisi','NAMA',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Nm_RenstraMisi',$data->Nm_RenstraMisi,['class'=>'form-control','placeholder'=>'Nama Misi'])}}
                    </div>
                </div>
                <div class="form-group">
