            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'RENSTRA\RENSTRAKebijakanController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['Kd_RenstraKebijakan'=>'KODE','Nm_RenstraKebijakan'=>'NAMA'], isset($search['kriteria'])?$search['kriteria']:'Kd_RenstraKebijakan',['class'=>'form-control'])}}
                        </div>
                    </div>
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RENSTRA Arah Kebijakan dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
