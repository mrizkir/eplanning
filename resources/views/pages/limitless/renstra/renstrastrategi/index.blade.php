...
@section('page_header')
    ...
    <span class="text-semibold">
        RENSTRASTRATEGI TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}  
    </span>
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li class="active">RENSTRASTRATEGI</li>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RenstraStrategi dengan id "+id);
                    }                    
                },
