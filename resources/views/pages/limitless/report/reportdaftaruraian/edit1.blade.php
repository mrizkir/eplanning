...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['url'=>route(Helper::getNameOfPage('update1'),['uuid'=>$renja->RenjaIndikatorID]),'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                                                 
    ...
    <div class="panel panel-flat border-top-lg border-top-info border-bottom-info" id="divdatatableindikatorkinerja">
        @include('pages.limitless.report.reportdaftaruraian.datatableindikatorkinerja')         
    </div>
</div>   
@endsection
