...
@section('page_sidebar')
    @include('pages.limitless.report.reportdaftaruraian.l_sidebar_usulan_create')
@endsection
...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['url'=>route(Helper::getNameOfPage('store4')),'method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
        ...
        <div class="panel-body">     
            ...
            <div class="form-group">
                {{Form::label('Sasaran_Angka','SASARAN URAIAN KEGIATAN',['class'=>'control-label col-md-2'])}}
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-6">
                            {{Form::text('Sasaran_Angka','',['class'=>'form-control','placeholder'=>'VOLUME'])}}
                        </div>
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian','',['class'=>'form-control','placeholder'=>'SATUAN','rows'=>3])}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-flat border-top-lg border-top-info border-bottom-info" id="divdatatablerinciankegiatan">
        @include('pages.limitless.report.reportdaftaruraian.datatablerinciankegiatan')         
    </div>
</div>   
@endsection
