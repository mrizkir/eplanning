        ...
        <div class="sidebar-category">
            ...
            <div class="category-content no-padding"> 
                <ul class="navigation navigation-main navigation-accordion">
                    <li>
                        <a href="{{route(Helper::getNameOfPage('show'),['uuid'=>$renja->RenjaID])}}">
                            <i class="icon-info3"></i><span>DETAIL USULAN KEGIATAN</span>
                        </a>
                    </li> 
                    <li{!!Request::route()->getName()==Helper::getNameOfPage('create1') ? ' class="active"':""!!}>
                        <a href="{{route(Helper::getNameOfPage('create1'),['uuid'=>$renja->RenjaID])}}">
                            <i class="icon-info3"></i><span>INDIKATOR KEGIATAN</span>
                        </a>
                    </li>  
                    <li{!!Request::route()->getName()==Helper::getNameOfPage('create2') ? ' class="active"':""!!}>
                        <a href="{{route(Helper::getNameOfPage('create2'),['uuid'=>$renja->RenjaID])}}">
                    ...
                    <li{!!Request::route()->getName()==Helper::getNameOfPage('create3') ? ' class="active"':""!!}>
                        <a href="{{route(Helper::getNameOfPage('create3'),['uuid'=>$renja->RenjaID])}}">
                            <i class="icon-info3"></i><span>RINCIAN KEGIATAN POKIR.</span>
                        </a>
                    </li>                   
                    <li{!!Request::route()->getName()==Helper::getNameOfPage('create4') ? ' class="active"':""!!}>
                        <a href="{{route(Helper::getNameOfPage('create4'),['uuid'=>$renja->RenjaID])}}">
