...
@section('page_title')
    LAPORAN RKPD OPD DAN UNIT KERJA RINCI
@endsection
...
<div class="row">      
    <div class="col-md-12" id="divfilter">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            <div class="panel-heading">
                <h5 class="panel-title"><i class="icon-file-empty position-left"></i> REKAP RKPD OPD DAN UNIT KERJA RINCI TAHUN PERENCANAAN {{HelperKegiatan::getTahunPerencanaan()}}</h5>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.report.reportrkpdmurniopdrinci.datatable')
    </div>
</div>
@endsection
