...
@section('page_title')
    RPJMD TUJUAN  {{config('eplanning.rpjmd_tahun_mulai')}} - {{config('eplanning.rpjmd_tahun_akhir')}}
@endsection
@section('page_header')
...
@section('page_breadcrumb')
    <li><a href="{!!route('rpjmdtujuan.index')!!}">RPJMD TUJUAN TAHUN {{config('eplanning.rpjmd_tahun_mulai')}} - {{config('eplanning.rpjmd_tahun_akhir')}}</a></li>
