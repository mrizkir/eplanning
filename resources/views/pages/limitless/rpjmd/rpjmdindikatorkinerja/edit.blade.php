    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::select('OrgIDRPJMD', $daftar_opd, $data->OrgIDRPJMD,['class'=>'select','id'=>'OrgIDRPJMD'])}}                   
                </div>
            </div>    
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::text('KondisiAwal',$data->KondisiAwal,['class'=>'form-control','placeholder'=>'KONDISI KINERJA AWAL'])}}
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="row">                
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('TargetN1',$data->TargetN1,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 1'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('TargetN2','TARGET TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+1),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('TargetN2',$data->TargetN2,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 2'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('TargetN3','TARGET TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+2),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('TargetN3',$data->TargetN3,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 3'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('TargetN4','TARGET TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+3),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('TargetN4',$data->TargetN4,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 4'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('TargetN5','TARGET TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+4),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('TargetN5',$data->TargetN5,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 5'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('KondisiAkhirTarget','KONDISI AKHIR TARGET '.(HelperKegiatan::getRPJMDTahunAkhir()+1),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('KondisiAkhirTarget',$data->KondisiAkhirTarget,['class'=>'form-control','placeholder'=>'TARGET TAHUN KE 5'])}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">                   
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('PaguDanaN1',$data->PaguDanaN1,['class'=>'form-control','placeholder'=>'PAGU DANA TAHUN KE 1','readonly'=>true])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('PaguDanaN2','PAGU DANA TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+1),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('PaguDanaN2',$data->PaguDanaN2,['class'=>'form-control','placeholder'=>'PAGU DANA TAHUN KE 2','readonly'=>true])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('PaguDanaN3','PAGU DANA TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+2),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('PaguDanaN3',$data->PaguDanaN3,['class'=>'form-control','placeholder'=>'PAGU DANA TAHUN KE 3','readonly'=>true])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('PaguDanaN4','PAGU DANA TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+3),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('PaguDanaN4',$data->PaguDanaN4,['class'=>'form-control','placeholder'=>'PAGU DANA TAHUN KE 4','readonly'=>true])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{Form::label('PaguDanaN5','PAGU DANA TAHUN '.(HelperKegiatan::getRPJMDTahunMulai()+4),['class'=>'control-label col-md-4'])}}
                        <div class="col-md-8">
                            {{Form::text('PaguDanaN5',$data->PaguDanaN5,['class'=>'form-control','placeholder'=>'PAGU DANA TAHUN KE 5','readonly'=>true])}}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {{Form::text('KondisiAkhirPaguDana',$data->KondisiAkhirPaguDana,['class'=>'form-control','placeholder'=>'PAGU DANA AKHIR TAHUN '.(HelperKegiatan::getRPJMDTahunAkhir()+1),'readonly'=>true])}}
                        </div>
                    </div>
                </div>
            </div>
