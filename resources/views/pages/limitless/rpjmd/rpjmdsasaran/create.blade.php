        ...
        <div class="panel-body">
            {!! Form::open(['action'=>'RPJMD\RPJMDSasaranController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        {{Form::text('Kd_Sasaran','',['class'=>'form-control','placeholder'=>'Kode Sasaran','maxlength'=>'4'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Nm_Sasaran','NAMA SASARAN',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Nm_Sasaran','',['class'=>'form-control','placeholder'=>'Nama Sasaran'])}}
                    </div>
                </div>
                <div class="form-group">
