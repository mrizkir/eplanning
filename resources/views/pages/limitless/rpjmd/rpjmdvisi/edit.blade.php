...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>['RPJMD\RPJMDVisiController@update',$data->RpjmdVisiID],'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                             
                <div class="form-group">
                    {{Form::label('Nm_RpjmdVisi','VISI',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::textarea('Nm_RpjmdVisi',$data->Nm_RpjmdVisi,['class'=>'form-control','placeholder'=>'VISI KEPALA DAERAH ATAU TEKNOKRATIK','rows' => 2, 'cols' => 40])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Descr','PERATURAN DAERAH',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::textarea('Descr',$data->Descr,['class'=>'form-control','placeholder'=>'PERATURAN DAERAH','rows' => 2, 'cols' => 40])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('TA_Awal','TAHUN KONDISI AWAL',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('TA_Awal',$data->TA_Awal,['class'=>'form-control','placeholder'=>'TAHUN KONDISI AWAL'])}}
                    </div>
                </div>
                <div class="form-group">            
