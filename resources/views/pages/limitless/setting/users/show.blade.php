        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">   
                    <a href="{{route('users.edit',['id'=>$data->users_id])}}" class="btn btn-primary btn-icon heading-btn btnEdit" title="Ubah Data Users">
                        <i class="icon-pencil7"></i>
                    </a>
                    <a href="javascript:;" title="Hapus Data Users" data-id="{{$data->users_id}}" data-url="{{route('users.index')}}" class="btn btn-danger btn-icon heading-btn btnDelete">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>users id: </strong></label>
                                <div class="col-md-8">
