...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>['Setting\UsersOPDController@update',$data->id],'method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}        
...
$(document).ready(function () {
    ...
    //styling select
    $('.select').select2({
        placeholder: "PILIH UNIT KERJA / OPD / SKPD",
        allowClear:true
    });
    $('#frmdata').validate({
        ignore:[],
