    ...
    <div class="panel-heading">       
        ...
        <div class="heading-elements">
            {!! Form::open(['url'=>'#','method'=>'post','class'=>'heading-form','id'=>'frmheading','name'=>'frmheading'])!!} 
                ...
                <div class="form-group">
                    <a href="{!!route('usersdewan.create')!!}" class="btn btn-info btn-xs" title="Tambah User Dewan">
                    ...
                    <td>
                        <ul class="icons-list">
                            <li class="text-primary-600">
                                <a class="btnShow" href="{{route('usersdewan.show',['id'=>$item->id])}}" title="Detail Data User Dewan">
                                    <i class='icon-eye'></i>
                                </a>  
                            </li>
                            <li class="text-primary-600">
                                <a class="btnEdit" href="{{route('usersdewan.edit',['id'=>$item->id])}}" title="Ubah Data User Dewan">
                                    <i class='icon-pencil7'></i>
                                </a>  
                            </li>
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data User Dewan" data-id="{{$item->id}}" data-url="{{route('usersdewan.index')}}">
