    ...
    <div class="panel-heading">       
        ...
        <div class="heading-elements">
            {!! Form::open(['url'=>'#','method'=>'post','class'=>'heading-form','id'=>'frmheading','name'=>'frmheading'])!!} 
                ...
                <div class="form-group">
                    <a href="{!!route('userskecamatan.create')!!}" class="btn btn-info btn-xs" title="Tambah User Kecamatan">
                    ...
                    <td>
                        <ul class="icons-list">
                            <li class="text-primary-600">
                                <a class="btnShow" href="{{route('userskecamatan.show',['id'=>$item->id])}}" title="Detail Data User Kecamatan">
                                    <i class='icon-eye'></i>
                                </a>  
                            </li>
                            <li class="text-primary-600">
                                <a class="btnEdit" href="{{route('userskecamatan.edit',['id'=>$item->id])}}" title="Ubah Data User Kecamatan">
                                    <i class='icon-pencil7'></i>
                                </a>  
                            </li>
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data User Kecamatan" data-id="{{$item->id}}" data-url="{{route('userskecamatan.index')}}">
