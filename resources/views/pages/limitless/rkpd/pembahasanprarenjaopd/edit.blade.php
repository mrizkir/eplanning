...
@section('page_breadcrumb')
    ...
    <li><a href="{!!route('pembahasanprarenjaopd.index')!!}">PEMBAHASAN PRA RENJA OPD</a></li>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list">                    
                    <li>               
                        <a href="{!!route('pembahasanprarenjaopd.index')!!}" data-action="closeredirect" title="keluar"></a>
                    </li>
                </ul>
            </div>
        </div>
        {!! Form::open(['action'=>['RKPD\PembahasanPraRenjaOPDController@update2',$renja->RenjaRincID],'method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
