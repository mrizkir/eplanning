...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['url'=>route(Helper::getNameOfPage('update2'),$rkpd->RenjaRincID),'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}         
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <p class="form-control-static">{{$rkpd->NmPk}} [{{$rkpd->Kd_PK}}]</p>
                </div>
            </div>  
            <div class="form-group">
                <label class="col-md-2 control-label">USULAN KEGIATAN</label> 
                <div class="col-md-10">
                    {{$rkpd->NamaUsulanKegiatan}}
                </div>
            </div>    
        </div>
        <div class="panel-body">                    
