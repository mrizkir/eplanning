...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'RKPD\TransferRKPDMurniTOPembahasan1@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        <label class="col-md-2 control-label">Kriteria :</label> 
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['kode_organisasi'=>'KODE TRANSFER RKPD MURNI --> PEMBAHASAN','OrgNm'=>'NAMA TRANSFER RKPD MURNI --> PEMBAHASAN'], isset($search['kriteria'])?$search['kriteria']:'kode_organisasi',['class'=>'form-control'])}}
                        </div>
                    </div>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.rkpd.transferrkpdmurnitopembahasan1.datatable')
    </div>
</div>
@endsection