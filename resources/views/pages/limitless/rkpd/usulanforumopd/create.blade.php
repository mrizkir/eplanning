...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>'RKPD\UsulanForumOPDController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian3','',['rows'=>3,'class'=>'form-control','placeholder'=>'URAIAN SASARAN'])}}
                        </div>
                    </div>                        
                </div>                   
            </div>            
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::text('Target3','',['class'=>'form-control','placeholder'=>'PERSENTASE TARGET KEGIATAN'])}}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {{Form::text('NilaiUsulan3',0,['class'=>'form-control','placeholder'=>'NILAI USULAN (TA)','id'=>'NilaiUsulan3','readonly'=>true])}}
                        </div> 
                        <div class="col-md-4">
...
$(document).ready(function () {
    ...
    $(document).on('change','#UrsID',function(ev) {
        ...
        $.ajax({
            type:'post',
            url: '{{route('usulanforumopd.index')}}/pilihusulankegiatan',
            dataType: 'json',
            data: {
                "_token": token,
                "UrsID": UrsID,
    ...
    $(document).on('change','#PrgID',function(ev) {
        ...
        $.ajax({
            type:'post',
            url: '{{route('usulanforumopd.pilihusulankegiatan')}}',
            dataType: 'json',
            data: {
                "_token": token,
                "PrgID": PrgID,
