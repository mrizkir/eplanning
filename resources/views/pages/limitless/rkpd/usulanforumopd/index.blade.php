...
@section('page_breadcrumb')
    <li class="active">USULAN FORUM OPD / SKPD</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.rkpd.usulanforumopd.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Usulan Forum OPD / SKPD dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
