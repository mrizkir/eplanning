...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>'RKPD\UsulanForumOPDController@store4','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian3','',['class'=>'form-control','placeholder'=>'URAIAN SASARAN','rows'=>3])}}
                        </div>
                    </div>
                </div>
            </div>
