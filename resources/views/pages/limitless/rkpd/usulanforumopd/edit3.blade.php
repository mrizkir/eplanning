...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>['RKPD\UsulanForumOPDController@update3',$renja->RenjaRincID],'method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}         
        ...
        <div class="panel-body">                    
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::text('Jumlah3',$renja->Jumlah3,['class'=>'form-control','placeholder'=>'NILAI USULAN'])}}
                </div>
            </div>
            <div class="form-group">
