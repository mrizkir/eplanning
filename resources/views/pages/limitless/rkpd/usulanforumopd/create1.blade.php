...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>'RKPD\UsulanForumOPDController@store1','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
...
$(document).ready(function () {
    ...
    $(document).on('change','#IndikatorKinerjaID',function(ev) {
        ...
        $.ajax({
            type:'post',
            url: '{{route('usulanforumopd.pilihindikatorkinerja')}}',
            dataType: 'json',
            data: {
                "_token": token,
