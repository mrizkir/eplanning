            ...
            <div class="panel-body">
                {!! Form::open(['url'=>route(Helper::getNameOfPage('search')),'method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['RKPDID'=>'RKPD ID','kode_subkegiatan'=>'KODE SUB KEGIATAN','SubKgtNm'=>'NAMA SUB KEGIATAN','Uraian'=>'NAMA URAIAN'], isset($search['kriteria'])?$search['kriteria']:'kode_subkegiatan',['class'=>'form-control'])}}
                        </div>
                    </div>
