...
<div class="row">
        ...
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            {!! Form::open(['url'=>route(Helper::getNameOfPage('search')),'method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['kode_subkegiatan'=>'KODE SUB KEGIATAN','SubKgtNm'=>'NAMA SUB KEGIATAN','Uraian'=>'NAMA URAIAN'], isset($search['kriteria'])?$search['kriteria']:'kode_subkegiatan',['class'=>'form-control'])}}
                        </div>
                    </div>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.rkpd.pembahasanrenja.datatable')
    </div>    
    <div class="col-md-12">
