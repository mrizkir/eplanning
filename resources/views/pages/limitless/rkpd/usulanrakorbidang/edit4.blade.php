...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>['RKPD\UsulanRAKORBidangController@update4',$renja->RenjaRincID],'method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
        ...
        <div class="panel-body">     
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::text('Jumlah2',Helper::formatUang($renja->Jumlah2),['class'=>'form-control','placeholder'=>'NILAI USULAN'])}}
                </div>
            </div>
            <div class="form-group">
