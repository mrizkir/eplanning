...
@section('page_header')
    ...
    <span class="text-semibold">
        USULAN RAKOR BIDANG TAHUN PERENCANAAN {{config('globalsettings.tahun_perencanaan')}}  
    </span>
@endsection
@section('page_info')
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'RKPD\UsulanRAKORBidangController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.rkpd.usulanrakorbidang.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Usulan RAKOR Bidang dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
