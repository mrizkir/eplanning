                    ...
                    <td>
                        <ul class="icons-list">
                            <li class="text-primary-600">
                                <a class="btnShow" href="{{route(Helper::getNameOfPage('show'),['uuid'=>$item->RenjaID])}}" title="Detail Data {{$page_title}}">
                                    <i class='icon-eye'></i>
                                </a>  
                            </li>
                            ...
                            <li class="text-primary-600">
                                @if ($item->isSKPD)
                                    <a class="btnEdit" href="{{route(Helper::getNameOfPage('edit4'),['uuid'=>$item->RenjaRincID])}}" title="Ubah Data {{$page_title}}">
                                        <i class='icon-pencil7'></i>
                                    </a> 
                                @elseif($item->isReses)
                                    <a class="btnEdit" href="{{route(Helper::getNameOfPage('edit3'),['uuid'=>$item->RenjaRincID])}}" title="Ubah Data {{$page_title}}">
                                        <i class='icon-pencil7'></i>
                                    </a>
                                @elseif(!empty($item->UsulanKecID))
                                    <a class="btnEdit" href="{{route(Helper::getNameOfPage('edit2'),['uuid'=>$item->RenjaRincID])}}" title="Ubah Data {{$page_title}}">
                                        <i class='icon-pencil7'></i>
                                    </a>
                                @else
                                    <a class="btnEdit" href="{{route(Helper::getNameOfPage('edit4'),['uuid'=>$item->RenjaRincID])}}" title="Ubah Data {{$page_title}}">
