...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['url'=>route(Helper::getNameOfPage('update1'),['id'=>$rkpd->RKPDIndikatorID]),'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                                              
    ...
    <div class="panel panel-flat border-top-lg border-top-info border-bottom-info" id="divdatatableindikatorkinerja">
        @include('pages.limitless.rkpd.pembahasanrkpdp.datatableindikatorkinerja')         
    </div>
</div>   
@endsection
