...
@endsection
@section('page_info')
    @include('pages.limitless.rkpd.usulan.info')
@endsection
@section('page_breadcrumb')
    <li><a href="#">WORKFLOW</a></li>
    <li><a href="{!!route('usulanprarenjaopd.index')!!}">{{$page_title}}</a></li>
    <li class="active">TAMBAH DATA RINCIAN KEGIATAN DARI OPD / SKPD</li>
@endsection
@section('page_sidebar')
    @include('pages.limitless.rkpd.usulan.l_sidebar_usulan_create')
@endsection
...
<div class="content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian','',['class'=>'form-control','placeholder'=>'URAIAN SASARAN','rows'=>3])}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-flat border-top-lg border-top-info border-bottom-info" id="divdatatablerinciankegiatan">
        @include('pages.limitless.rkpd.usulan.datatablerinciankegiatan')         
    </div>
</div>   
@endsection
