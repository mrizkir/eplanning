                    ...
                    <td>
                        <ul class="icons-list">
                            <li class="text-primary-600">
                                <a class="btnShow" href="{{route('desa.show',['uuid'=>$item->PmDesaID])}}" title="Detail Data Desa">
                                    <i class='icon-eye'></i>
                                </a>  
                            </li>
                            <li class="text-primary-600">
                                <a class="btnEdit" href="{{route('desa.edit',['uuid'=>$item->PmDesaID])}}" title="Ubah Data Desa">
