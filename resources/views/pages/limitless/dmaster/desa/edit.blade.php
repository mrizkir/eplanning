    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <ul class="icons-list">                    
                    <li>               
                        <a href="{!!route('desa.index')!!}" data-action="closeredirect" title="keluar"></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="panel-body">
            {!! Form::open(['action'=>['DMaster\DesaController@update',$data->PmDesaID],'method'=>'put','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                <div class="form-group">
                    {{Form::label('PmKecamatanID','KECAMATAN',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::select('PmKecamatanID', $kecamatan, $data->PmKecamatanID,['class'=>'form-control select','id'=>'PmKecamatanID'])}}                        
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Kd_Desa','KODE DESA',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Kd_Desa',$data->Kd_Desa,['class'=>'form-control','placeholder'=>'KODE DESA','maxlength'=>4])}}
                    </div>
                </div>  
                <div class="form-group">
                    {{Form::label('Nm_Desa','NAMA DESA',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Nm_Desa',$data->Nm_Desa,['class'=>'form-control','placeholder'=>'NAMA DESA'])}}
                    </div>
                </div>
                <div class="form-group">
