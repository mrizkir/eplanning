    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <div class="heading-btn">
                <a href="{!!route('pagudanarpjmd.create')!!}" class="btn btn-info btn-xs" title="Tambah PAGUDANARPJMD">
                    ...
                    <td>
                        <ul class="icons-list">
                            ...
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data PaguDanaRPJMD" data-id="{{$item->pagudanarpjmd_id}}" data-url="{{route('pagudanarpjmd.index')}}">
