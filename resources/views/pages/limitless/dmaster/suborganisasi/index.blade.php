...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\SubOrganisasiController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.suborganisasi.datatable')
    </div>
</div>
@endsection
...
$(document).ready(function () {  
    $("#divdatatable").on("click",".btnDelete", function(){
        if (confirm('Apakah Anda ingin menghapus Data Unit Kerja ini ?')) {
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Unit Kerja dengan id "+id);
                    }                    
                },
