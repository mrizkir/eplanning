...
@section('page_header')
    ...
    <span class="text-semibold"> 
        PAGU ANGGARAN OPD / SKPD TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}
    </span>
@endsection
@section('page_info')
...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>'DMaster\PaguAnggaranOPDController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        {{Form::text('Jumlah1','',['class'=>'form-control','placeholder'=>'NILAI PAGU ANGGARAN APBD'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('Jumlah2','PAGU ANGGARAN APBDP',['class'=>'control-label col-md-2'])}}
                    <div class="col-md-10">
                        {{Form::text('Jumlah2','',['class'=>'form-control','placeholder'=>'NILAI PAGU ANGGARAN APBD'])}}
                    </div>
                </div>
                <div class="form-group">
