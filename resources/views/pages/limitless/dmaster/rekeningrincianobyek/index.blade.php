...
@section('page_breadcrumb')
    <li class="active">REKENINGRINCIANOBYEK</li>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\RekeningRincianObyekController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.rekeningrincianobyek.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RekeningRincianObyek dengan id "+id);
                    }                    
                },
