...
@section('page_title')
    REKENINGRINCIANOBYEK
@endsection
@section('page_header')
    <i class="icon-price-tag position-left"></i>
    <span class="text-semibold"> 
        REKENINGRINCIANOBYEK TAHUN PERENCANAAN {{config('globalsettings.tahun_perencanaan')}}
    </span>     
@endsection
@section('page_info')
    @include('pages.limitless.dmaster.rekeningrincianobyek.info')
@endsection
@section('page_breadcrumb')
    <li><a href="{!!route('rekeningrincianobyek.index')!!}">REKENINGRINCIANOBYEK</a></li>
        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">   
                    ...
                    <a href="{!!route('rekeningrincianobyek.index')!!}" class="btn btn-default btn-icon heading-btn" title="keluar">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>rekeningrincianobyek id: </strong></label>
                                <div class="col-md-8">
                                    <p class="form-control-static">{{$data->rekeningrincianobyek_id}}</p>
                                </div>                            
                            </div>                            
                            <div class="form-group">
...
$(document).ready(function () {
    $(".btnDelete").click(function(ev) {
        if (confirm('Apakah Anda ingin menghapus Data RekeningRincianObyek ini ?')) {
