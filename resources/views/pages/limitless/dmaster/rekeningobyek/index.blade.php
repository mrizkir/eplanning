...
@section('page_header')
    ...
    <span class="text-semibold">
        REKENINGOBYEK TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}  
    </span>
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li class="active">REKENINGOBYEK</li>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\RekeningObyekController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.rekeningobyek.datatable')
    </div>
</div>
@endsection
...
$(document).ready(function () {  
    $("#divdatatable").on("click",".btnDelete", function(){
        if (confirm('Apakah Anda ingin menghapus Data RekeningObyek ini ?')) {
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RekeningObyek dengan id "+id);
                    }                    
                },
