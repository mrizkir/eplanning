...
@section('page_breadcrumb')
    ...
    <li class="active">PAGU ANGGARAN ANGGOTA DEWAN</li>
@endsection
...
<div class="row">    
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\PaguAnggaranDewanController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        <label class="col-md-2 control-label">Kriteria :</label> 
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['OrgNm'=>'NAMA ANGGOTA DEWAN'], isset($search['kriteria'])?$search['kriteria']:'OrgNm',['class'=>'form-control'])}}
                        </div>
                    </div>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.paguanggarandewan.datatable')
    </div>
</div>
@endsection
