...
<script src="{!!asset('theme/limitless/assets/jquery-validation/dist/jquery.validate.min.js')!!}"></script>
<script src="{!!asset('theme/limitless/assets/jquery-validation/dist/additional-methods.min.js')!!}"></script>
@endsection
