        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">
                    ...
                    <a href="{!!route('fungsi.index')!!}" class="btn btn-default btn-icon heading-btn" title="keluar">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>fungsi id: </strong></label>
                                <div class="col-md-8">
                                    <p class="form-control-static">{{$data->fungsi_id}}</p>
                                </div>                            
                            </div>                            
                            <div class="form-group">
