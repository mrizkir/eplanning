...
@section('page_header')
    ...
    <span class="text-semibold">
        MAPPINGURUSANTOFUNGSI TAHUN PERENCANAAN {{HelperKegiatan::getTahunPerencanaan()}}  
    </span>
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li class="active">MAPPINGURUSANTOFUNGSI</li>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\MappingUrusanToFungsiController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.mappingurusantofungsi.datatable')
    </div>
</div>
@endsection
...
$(document).ready(function () {  
    $("#divdatatable").on("click",".btnDelete", function(){
        if (confirm('Apakah Anda ingin menghapus Data MappingUrusanToFungsi ini ?')) {
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data MappingUrusanToFungsi dengan id "+id);
                    }                    
                },
