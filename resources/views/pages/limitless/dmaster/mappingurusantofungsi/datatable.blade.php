    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <div class="heading-btn">
                <a href="{!!route('mappingurusantofungsi.create')!!}" class="btn btn-info btn-xs" title="Tambah MAPPINGURUSANTOFUNGSI">
                    ...
                    <td>
                        <ul class="icons-list">
                            ...
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data MappingUrusanToFungsi" data-id="{{$item->mappingurusantofungsi_id}}" data-url="{{route('mappingurusantofungsi.index')}}">
