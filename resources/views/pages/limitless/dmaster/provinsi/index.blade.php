...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\ProvinsiController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
                        <label class="col-md-2 control-label">Kriteria :</label> 
                        <div class="col-md-10">
                            {{Form::select('cmbKriteria', ['Kd_Provinsi'=>'KODE PROVINSI','Nm_Prov'=>'NAMA PROVINSI'], isset($search['kriteria'])?$search['kriteria']:'Kd_Provinsi',['class'=>'form-control'])}}
                        </div>
                    </div>
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.provinsi.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Provinsi dengan id "+id);
                    }                    
                },
