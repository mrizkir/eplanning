    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <div class="heading-btn">
                <a href="{!!route('rekeningrincianobyekbelanjamodal.create')!!}" class="btn btn-info btn-xs" title="Tambah REKENINGRINCIANOBYEKBELANJAMODAL">
                    ...
                    <td>
                        <ul class="icons-list">
                            ...
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data RekeningRincianObyekBelanjaModal" data-id="{{$item->rekeningrincianobyekbelanjamodal_id}}" data-url="{{route('rekeningrincianobyekbelanjamodal.index')}}">
