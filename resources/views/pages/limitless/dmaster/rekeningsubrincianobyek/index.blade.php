...
@section('page_header')
    ...
    <span class="text-semibold">
        REKENINGRINCIANOBYEKBELANJAMODAL TAHUN PERENCANAAN {{config('globalsettings.tahun_perencanaan')}}  
    </span>
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li class="active">REKENINGRINCIANOBYEKBELANJAMODAL</li>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'DMaster\RekeningRincianObyekBelanjaModalController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.dmaster.rekeningrincianobyekbelanjamodal.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data RekeningRincianObyekBelanjaModal dengan id "+id);
                    }                    
                },
