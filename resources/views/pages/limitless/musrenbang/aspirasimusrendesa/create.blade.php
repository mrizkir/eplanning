...
<div class="content">
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            {!! Form::open(['action'=>'Musrenbang\AspirasiMusrenDesaController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                                              
                <div class="form-group">
                    <label class="col-md-2 control-label">KECAMATAN: </label>
                    <div class="col-md-10">
                        <p class="form-control-static">
                            <span class="label border-left-primary label-striped">{{$kecamatan->Nm_Kecamatan}}</span>
                        </p>
                    </div>                            
                </div>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        {{Form::text('Output','',['class'=>'form-control','placeholder'=>'OUTPUT / KELUARAN'])}}
                    </div>
                </div>
                <div class="form-group">
