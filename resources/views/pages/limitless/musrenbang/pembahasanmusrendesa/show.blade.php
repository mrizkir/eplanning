...
@section('page_header')
    ...
    <span class="text-semibold"> 
        PEMBAHASANMUSRENDESA TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}
    </span>     
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li><a href="{!!route('pembahasanmusrendesa.index')!!}">PEMBAHASANMUSRENDESA</a></li>
        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">   
                    ...
                    <a href="{!!route('pembahasanmusrendesa.index')!!}" class="btn btn-default btn-icon heading-btn" title="keluar">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>pembahasanmusrendesa id: </strong></label>
                                <div class="col-md-8">
                                    <p class="form-control-static">{{$data->pembahasanmusrendesa_id}}</p>
                                </div>                            
                            </div>                            
                            <div class="form-group">
