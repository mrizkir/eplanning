...
@section('page_header')
    ...
    <span class="text-semibold"> 
        PEMBAHASAN MUSRENBANG KECAMATAN TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}
    </span>     
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    <li><a href="{!!route('pembahasanmusrenkecamatan.index')!!}">PEMBAHASAN MUSRENBANG KECAMATAN</a></li>
        ...
        <div class="panel panel-flat border-top-info border-bottom-info">
            <div class="panel-heading">
                ...
                <div class="heading-elements">   
                    ...
                    <a href="{!!route('pembahasanmusrenkecamatan.index')!!}" class="btn btn-default btn-icon heading-btn" title="keluar">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-md-4 control-label"><strong>pembahasanmusrenkecamatan id: </strong></label>
                                <div class="col-md-8">
                                    <p class="form-control-static">{{$data->pembahasanmusrenkecamatan_id}}</p>
                                </div>                            
                            </div>                            
                            <div class="form-group">
...
$(document).ready(function () {
    $(".btnDelete").click(function(ev) {
        if (confirm('Apakah Anda ingin menghapus Data PembahasanMusrenKecamatan ini ?')) {
