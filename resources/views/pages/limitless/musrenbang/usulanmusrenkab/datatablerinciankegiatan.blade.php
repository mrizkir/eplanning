<div class="panel-heading">
    ...
    <div class="heading-elements">        
        @if (Request::route()->getName()=='usulanmusrenkab.show')
        <div class="heading-btn">
            <a href="{!!route('usulanmusrenkab.create2',['id'=>$renja->RenjaID])!!}" class="btn btn-info btn-xs" title="Tambah Rincian Kegiatan dari Musren">
                <i class="icon-googleplus5"></i>
            </a>
            <a href="{!!route('usulanmusrenkab.create3',['id'=>$renja->RenjaID])!!}" class="btn btn-success btn-xs" title="Tambah Rincian Kegiatan dari POKIR">
                <i class="icon-googleplus5"></i>
            </a>
            <a href="{!!route('usulanmusrenkab.create4',['id'=>$renja->RenjaID])!!}" class="btn btn-primary btn-xs" title="Tambah Rincian Kegiatan">
                <i class="icon-googleplus5"></i>
            </a>
        </div>  
        @endif  
                ...
                <td>
                    ...
                    <ul class="icons-list">
                        ...
                        <li class="text-danger-600">
                            <a class="btnDelete" href="javascript:;" title="Hapus Data Idikator" data-id="{{$item->RenjaRincID}}" data-url="{{route('usulanmusrenkab.index')}}">
