...
@section('page_breadcrumb')
    <li class="active">USULAN MUSRENBANG KABUPATEN</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-flat border-top-lg border-top-info border-bottom-info">
            ...
            <div class="panel-body">
                {!! Form::open(['action'=>'RKPD\UsulanForumOPDController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                                
                    <div class="form-group">
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.musrenbang.usulanmusrenkab.datatable')
    </div>
</div>
@endsection
...
$(document).ready(function () {  
    ...
    $("#divdatatable").on("click",".btnDelete", function(){
        if (confirm('Apakah Anda ingin menghapus Data Usulan Musrenbang Kabupaten ini ?')) {
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data Usulan Musrenbang Kabupaten dengan id "+id);
                    }                    
                },
                error:function(xhr, status, error){
                    console.log('ERROR');
