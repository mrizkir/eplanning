    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <div class="heading-btn">
                <a href="{!!route('usulanmusrenkab.create')!!}" class="btn btn-info btn-xs" title="Tambah Usulan Kegiatan">
            ...
            @foreach ($data as $key=>$item)
                <tr>
                    ...
                    <td colspan="6">
                        ...
                        <a href="{{route('usulanmusrenkab.create1',['uuid'=>$item->RenjaID])}}">
                            Lanjutkan Input 
                        </a>
                    </td>
                    <td>
                        <ul class="icons-list">                            
                            <li class="text-danger-600">
                                <a class="btnDelete" href="javascript:;" title="Hapus Data Usulan Musren Kabupaten" data-id="{{$item->RenjaID}}" data-url="{{route('usulanmusrenkab.index')}}" data-pid="renja">
                    ...
                    <td>
                        <ul class="icons-list">
                            <li class="text-primary-600">
                                <a class="btnShow" href="{{route('usulanmusrenkab.show',['id'=>$item->RenjaID])}}" title="Detail Data Usulan Musren Kabupaten">
                                    <i class='icon-eye'></i>
                                </a>  
                            </li>
                            @if ($item->Privilege==0)
