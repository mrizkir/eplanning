...
<div class="content">
    <div class="panel panel-flat">
        ...
        {!! Form::open(['action'=>'Musrenbang\UsulanMusrenKabController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{Form::textarea('Sasaran_Uraian4','',['rows'=>3,'class'=>'form-control','placeholder'=>'URAIAN SASARAN'])}}
                        </div>
                    </div>                        
                </div>                   
            </div>            
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::text('Target4','',['class'=>'form-control','placeholder'=>'PERSENTASE TARGET KEGIATAN'])}}
                </div>
            </div>
            <div class="form-group">
...
$(document).ready(function () {
    ...
    $(document).on('change','#UrsID',function(ev) {
        ...
        $.ajax({
            type:'post',
            url: '{{route('usulanmusrenkab.index')}}/pilihusulankegiatan',
            dataType: 'json',
            data: {
                "_token": token,
                "UrsID": UrsID,
    ...
    $(document).on('change','#PrgID',function(ev) {
        ...
        $.ajax({
            type:'post',
            url: '{{route('usulanmusrenkab.pilihusulankegiatan')}}',
            dataType: 'json',
            data: {
                "_token": token,
                "PrgID": PrgID,
