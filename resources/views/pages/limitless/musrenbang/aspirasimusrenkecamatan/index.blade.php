...
@section('page_header')
    ...
    <span class="text-semibold">
        USULAN KECAMATAN TAHUN PERENCANAAN {{config('eplanning.tahun_perencanaan')}}  
    </span>
@endsection
@section('page_info')
...
@section('page_breadcrumb')
    ...
    <li class="active">USULAN KECAMATAN</li>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.limitless.musrenbang.aspirasimusrenkecamatan.datatable')
    </div>
</div>
@endsection
