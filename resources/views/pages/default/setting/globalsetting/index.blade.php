...
@section('page_breadcrumb')
    <li class="active">GLOBALSETTING</li>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            {!! Form::open(['action'=>'Setting\GlobalSettingController@search','method'=>'post','class'=>'form-horizontal','id'=>'frmsearch','name'=>'frmsearch'])!!}                
                <div class="box-body">                
    ...
    <div class="col-md-12" id="divdatatable">
        @include('pages.default.setting.globalsetting.datatable')
    </div>
</div>
@endsection
            ...
            $.ajax({            
                ...
                success:function(result){ 
                    if (result.success==1){
                        ...
                        console.log("Gagal menghapus data GlobalSetting dengan id "+id);
                    }                    
                },
