...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            {!! Form::open(['action'=>'Setting\UsersController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}
                <div class="box-body">                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            {{Form::select('role_name[]', $daftar_roles,'',['class'=>'form-control select2','multiple' => 'multiple','data-placeholder'=>'Pilih Role','id'=>'role_name'])}}                                
                        </div>
                    </div>   
                    <div class="form-group">
                        {{Form::label('do_sync','SYNCING ROLE ?',['class'=>'control-label col-md-2'])}}
                        <div class="col-md-10">
                            {{Form::checkbox("do_sync", 1,1,['class'=>'minimal'])}}  
                        </div>
                    </div>                             
                </div>
