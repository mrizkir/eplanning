...
class CreateVUsulanRakorBidang90View extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('CREATE VIEW v_usulan_rakor_bidang90 AS
             SELECT 
                A."RenjaID",
                K."RenjaRincID",
                A."OrgID",
    ...
    {
        \DB::statement('DROP VIEW v_usulan_rakor_bidang90');
    }
}
