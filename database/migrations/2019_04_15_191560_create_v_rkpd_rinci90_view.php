...
class CreateVRkpdRinci90View extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('CREATE VIEW v_rkpd_rinci90 AS
            SELECT 
                A."RKPDID",		
                K."RKPDRincID",
                A."OrgID",
            ...
            LEFT JOIN "trRKPDRinc90" K ON A."RKPDID"=K."RKPDID"
    ...
    {
        \DB::statement('DROP VIEW v_rkpd_rinci90');
    }
}
