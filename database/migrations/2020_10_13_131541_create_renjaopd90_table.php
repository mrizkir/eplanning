...
class CreateRenjaopd90Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trRenja90', function (Blueprint $table) {
        ...
        Schema::create('trRenjaIndikator90', function (Blueprint $table) {
        ...
        Schema::create('trRenjaRinc90', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('trRenjaRinc90');
        Schema::dropIfExists('trRenjaIndikator90');
        Schema::dropIfExists('trRenja90');
    }
}